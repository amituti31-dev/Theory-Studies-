...
class EdgeTtsService {
  ...
  static String get _scriptPath {
    ...
    return '$exeDir/data/flutter_assets/assets/tts_server.py';
  }

  /// On Linux the TTS sidecar runs under python3 from PATH. The user installs
  /// the packages once with:  pip3 install --user edge-tts aiohttp
  static String get _pythonExe {
    final exeDir = File(Platform.resolvedExecutable).parent.path;
    final venv = '$exeDir/python/bin/python3';
    return File(venv).existsSync() ? venv : 'python3';
  }
